...
public class Fiq_CreateActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fiq_activity_create);
        ...
        saveButton.setOnClickListener(v -> {
            ...
            if (!kegiatan.isEmpty() && !lokasi.isEmpty() && imageUri != null) {
                ...
                Toast.makeText(Fiq_CreateActivity.this, "Please fill all fields and choose an image", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void saveDataToDatabase(String kegiatan, String lokasi, String imageUrl) {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                newItemRef.setValue(new Fiq_Maps(kegiatan, lokasi, imageUrl))
                        .addOnSuccessListener(aVoid -> {
                            Toast.makeText(Fiq_CreateActivity.this, "Item added successfully", Toast.LENGTH_SHORT).show();
                            finish();
                        })
                        .addOnFailureListener(e -> Toast.makeText(Fiq_CreateActivity.this, "Failed to save data", Toast.LENGTH_SHORT).show());
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Fiq_CreateActivity.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
